...
def run_test_problem3a():
    ...
    # Window 4:
    title = 'Problem 3a. Test 5: Start at (67, 34), 32 lines'
    window4 = rg.RoseWindow(800, 800, title)

    # Test 5 (it is on window 3):
    point = rg.Point(67, 34)
    expected = 374
    answer = problem3a(window4, point, 32)
    print()
...
def problem3a(window, point, n):
    ...
    aggregated_thickness = 0
    thickness = -1
    for k in range(0, n*20, 20):
        line = rg.Line(rg.Point(point.x+k, point.y+(k/2)), rg.Point(point.x+k, point.y+(k/2)+50))
        ...
        window.render()
        aggregated_thickness = aggregated_thickness + thickness
    return aggregated_thickness
...
def problem3b(m, point1):
    ...
    for k in range(3, 3+(m*2), 2):
        ...
        sum_of_thickness = sum_of_thickness + problem3a(window, rg.Point(point1.x, point1.y+((k-1)*30)), k)
        window.render
